...
<head>
    ...
    <title>Tambah Karyawan | Sistem Presensi</title>
    ...
    <main class="main-content" style="margin-left: 0; padding: 40px; display: flex; justify-content: center;">
        <div class="section-card" style="max-width: 600px; width: 100%;">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
                <h2 style="margin: 0;">Tambah Karyawan Baru</h2>
            ...
            <form method="POST">
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="nama" required style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
                </div>
                ...
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-size: 0.9rem; margin-bottom: 5px; color: var(--text-dark);">Password (Default)</label>
                    <input type="text" name="password" required value="123456" style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
                </div>
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <select name="tipe_users_id" required style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px; background: white;">
                        <?php while ($tRow = $stmtTipe->fetch(PDO::FETCH_ASSOC)): ?>
                            <option value="<?php echo $tRow['id']; ?>"><?php echo htmlspecialchars($tRow['nama']); ?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
