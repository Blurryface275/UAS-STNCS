...
app.get('/api/attendance', async (req, res) => {
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('GetAllAttendance');
...
app.post('/api/attendance', async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: 'Attendance berhasil disimpan ke blockchain'
        });
...
app.get('/api/tasks', async (req, res) => {
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('GetAllTasks');
...
app.post('/api/tasks', async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: 'Task berhasil disimpan ke blockchain'
        });
...
app.get('/api/verification', async (req, res) => {
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('GetAllVerification');
...
app.post('/api/verification', async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: 'Verification berhasil disimpan ke blockchain'
        });
